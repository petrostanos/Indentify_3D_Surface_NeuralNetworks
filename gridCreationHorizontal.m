...
function [node,curv,e]=gridCreationHorizontal(point,BM,step,dslim)
    ...
    % real values of L and N in each point of function
    ...
    % e is matrix with curvature directions
    [surface1,~,e]=findSurface(eigenvalues,dx,dy,point);
    % parameters of function z=Ax+By+C
    A=surface1(1); B=surface1(2); C=surface1(3);
    % first value of x
    px=point(1);
